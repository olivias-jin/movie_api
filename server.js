...
// CORS setup
let allowedOrigins = ['http://localhost:4200','http://localhost:8080', 'http://testsite.com','http://localhost:1234','https://myflix-movies-oj.netlify.app','https://olivias-jin.github.io'];
app.use(cors({
